      ...
      <div className="min-w-0 flex-1">
        <header className="border-b border-neutral-200 bg-white/80 backdrop-blur">
          <div className="px-8 py-6">
            ...
            <h1 className="mt-1 text-xl font-bold text-neutral-900">Clients</h1>
        ...
        <main className="mx-auto max-w-5xl px-8 py-8">
          <div className="mb-5 flex items-center justify-between">
            ...
            <Link
              ...
              className="rounded-xl bg-neutral-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-brand-600"
            >
              + New client
            </Link>
          </div>
          ...
          {engagements.length === 0 ? (
            <div className="rounded-xl border border-dashed border-neutral-300 bg-white p-10 text-center">
              ...
              <Link href="/engagements/new" className="mt-2 inline-block text-sm font-medium text-brand-600 hover:underline">
              ...
              {engagements.map((e) => (
                <li key={e.id} className="relative">
                  ...
                  <Link
                    ...
                    className="block h-full rounded-xl border border-neutral-200 bg-white p-5 shadow-card transition hover:-translate-y-0.5 hover:border-brand-300 hover:shadow-lg"
                  >
                    <div className="flex items-start justify-between gap-3 pr-14">
                      <div className="text-base font-semibold text-neutral-900">{e.orgName}</div>
